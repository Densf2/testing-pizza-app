    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Your favorite pizza delivered fresh and fast to your doorstep. 
              Quality ingredients, authentic recipes, and exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:contact@pizzaexpress.com" className="text-gray-300 hover:text-orange-500 transition-colors text-sm">
                  Contact Us
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/disclaimer" className="text-gray-300 hover:text-orange-500 transition-colors text-sm">
                  Disclaimer
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-gray-400 text-sm">
            Copyright © {new Date().getFullYear()} Pizza Express Ltd. | All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
